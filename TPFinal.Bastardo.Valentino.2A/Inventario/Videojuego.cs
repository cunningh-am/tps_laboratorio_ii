...
namespace InventarioNS
{
    public class Videojuego:Producto,IMostrar
    {
        ...
        public Videojuego(int id, string nombre, double precio, int unidadesVendidas, TipoConsola tipo, Genero genero):this(nombre,precio,unidadesVendidas,tipo,genero)
        {
            this.id = id;
        }
