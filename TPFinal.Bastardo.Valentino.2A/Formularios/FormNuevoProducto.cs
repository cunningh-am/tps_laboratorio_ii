...
namespace Formularios
{
    public partial class FormNuevoProducto : Form
    {
        ...
        public FormNuevoProducto(Inventario inventario,AccesoSql sql):this()
        {
            inv = inventario;
            this.sql = sql;
        }
